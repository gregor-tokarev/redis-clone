use crate::{command_context::CommandContext, command_router::Command, resp_utils::build_bulk, transaction::TransactionContainer};
use tokio::{io::AsyncWriteExt, net::TcpStream};

pub async fn info_command(socket: &mut TcpStream, context: &CommandContext, _command: Command, _transaction: &mut TransactionContainer) {
